    ...
    public class BaseWebDriverTest
    {
        ...
        public IWebElement GetElement(By by)
        {
            ...
            catch (TimeoutException ex)
            {
                ...
                throw new WebDriverTask.Exceptions.NoSuchElementException(by, this, ex);
            }
        ...
        public bool IsElementPresent(By by)
        {
            ...
            catch (WebDriverTask.Exceptions.NoSuchElementException ex)
            {
                log.Error(ex.Message);
                return false;
            }
        ...
        public void WaitForChecked(By by)
        {
            ...
            if (!isSelected)
            {
                ...
                throw new WebDriverTask.Exceptions.NotCheckedException(by, this);
            }
        }
        ...
        public void WaitForNotChecked(By by)
        {
            ...
            if (!isSelected)
            {
                ...
                throw new WebDriverTask.Exceptions.StillCheckedException(by, this);
            }
        }
        ...
        public void WaitForTextPresent(string textToFind, bool shouldWait = true)
        {
            for (int second = 0;; second++)
            {
                if (second >= this.TimeOut)
                {
                    ...
                    throw new WebDriverTask.Exceptions.TextNotFoundException(textToFind, this);
                }
                try
                {
